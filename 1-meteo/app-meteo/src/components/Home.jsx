                ...
                <Card className='single-card'>
                    <CardBody>
                        <div className='flex'>
                            ...
                            <Card.Text className='minmax'>min: {city?.main?.temp_min.toFixed()} <br />max: {city?.main?.temp_max.toFixed()}</Card.Text>
                            <Card.Text className='card-text'>{city?.main?.temp} °C</Card.Text>
                            </div>
                        </div>
                ...
                <Card className='single-card'>
                    <CardBody>
                        <div className='flex'>
                            ...
                            {city2 && city2.list && <Card.Text className='card-text'>{city2?.list[8]?.main?.temp.toFixed()} °C</Card.Text>}
                            </div>
                        </div>
